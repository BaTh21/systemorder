// src/pages/HomePage.jsx - Fully Responsive with CSS Grid
import {
...
const HomePage = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#ffffff', position: 'relative' }}>
      ...
      {/* Features Strip - Using CSS Grid instead of MUI Grid */}
      <Box sx={{ bgcolor: 'white', borderBottom: '1px solid #f1f5f9', py: { xs: 1.5, sm: 2, md: 3 } }}>
        <Container>
          <Box sx={featuresGridStyle}>
            {[
              { icon: <LocalShipping />, title: 'Fast Delivery', desc: 'Phnom Penh $2, Province $3' },
      ...
      {/* Featured Products - Using CSS Grid instead of MUI Grid */}
